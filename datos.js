...
const usuarioVista = require('./vista/UsuarioVista');
const reportesVista = require('./vista/ReportesVista');
const eventosVista = require('./vista/EventosVista');
const forosVista = require('./vista/ForosVista');
const incidentesVista = require('./vista/IncidentesVista');
